...
const edit = props => {
  ...
  const setValueExperience = (e, index) => {
    const newExperience = getExperience.experience.map((item, i) => {
        ...
        <div className={styles.boxProfile}>
          <div className="row">
            <div className="col-md-3">
              <div className={styles.boxInfo}>
                ...
                <div className={styles.location}>
                  <Image src="/location.svg" width={20} height={20} alt="profile" />
            ...
            <div className="col-md-9">
              ...
              {getExperience.experience.map((item, index) => {
                return (
                  <div className={styles.boxCard} key={index}>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <Input
                          ...
                          onChange={e => setValueExperience(e, index)}
                        />
                      </div>
                      <div className="col-md-6">
                        <Input title="Bulan/tahun" type="date" onChange={e => setValueExperience(e, index)} />
                      </div>
                    ...
                    />
                    <hr />
                    {/* <button className={styles.btnAdd} onClick={addExperience}>
                      Tambah pengalaman kerja
                    </button> */}
                    <button className={styles.btnAdd} onClick={() => console.log(getExperience)}>
                      Tambah pengalaman kerja
                    </button>
                  </div>
                );
